...
<div class="calc">
    ...
    <div class="col-md-3 col-sm-3">
        <ul>
            ...
            <div class="radio"><input {if:__loop__=1}checked="checked"{endif:__loop__=1} id="optionsRadios{__loop__}" name="optionsRadios" type="radio" value="option{__loop__}" /></div>
            </li>
            {endloop:data}
